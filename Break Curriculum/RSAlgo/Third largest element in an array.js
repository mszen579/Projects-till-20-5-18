...
thirdMax([2,1,-4,7,100]);

  /* PSEUDO CODE:
To Declare a function thirdMax() that outputs 3rd Highest Number in any array:
1 - Create a function called thirdMax
...
8 - Finally retun the third max element after the array being sorted from the highest to the lowest element
9 - Call the function for the array [2,1,-4,7,100,-3].
...
------------------------------------------------------
we repeat until i and j reaches array.length-1
=>
return(the thirdmax will be)          |7
