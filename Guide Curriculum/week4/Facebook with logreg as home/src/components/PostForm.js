...
class PostForm extends Component {
    ...
    handleAddPost(event){
        ...
        axios.post('http://localhost:8000/api/addpost', record)
            .then( result =>{
                _this.setState({
                    data:{
                        text:''
            ...
            <div className="col col-md-12">
                ...
                <form onSubmit={this.handleAddPost}>
                    <div className="form-group">
                        <textarea onChange={this.handleChange} className="form-control" name="text" value={this.state.data.text} ref="text" placeholder="Add post here"
                        ></textarea>
