                ...
                {this.state.posts.map(function(post){
                            ...
                            return(
                                ...
                                <div key={post._id}>
                                    ...
                                    <button className="btn btn-success" onClick={this.handleVote.bind(this, post._id)}>Like</button>
                                    <button className="btn btn-warning" onClick={this.handleUnVote.bind(this, post._id)}>Un-Like</button>
                                    {/* if there is a usersession show me the delete button for that user posts */}
                                    {this.state.user._id==post.userID && <Link className="btn btn-danger" onClick={this.deletePost} to={'/deletepost/'+post._id}>Delete</Link>  }
                                    <hr />
                                </div>  
                            )
                        }.bind(this))}
