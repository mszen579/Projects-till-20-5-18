...
export default class Register extends Component {
    ...
    render() { 
        return ( 
            <div>
                <h1>New to TechTalks?</h1>
                <h3>Create a TechTalks account here</h3>
                <form onSubmit={this.handleSubmit}> 
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" name="email" value={this.state.data.email} onChange={this.handleChange} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
                        <h3 className="text-danger">{this.state.error.email}</h3>
                    </div>
                    <div className="form-group">
                        <label htmlFor="exampleInputname">A short descreption about you</label>
                        <input type="text" name="jobTitle" value={this.state.data.jobTitle} onChange={this.handleChange} className="form-control" id="exampleInputjobTitle"  placeholder="A short descreption about you" />
